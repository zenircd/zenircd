/************************************************************************
 * ZenIRCd - Zen Internet Relay Chat Daemon - src/api-apicallback.c
...
#ifdef APICALLBACKDEBUG
	zen_log(ULOG_DEBUG, "module", "API_CALLBACK_DEBUG", NULL, "APICallbackAdd()");
	print_apicallbacks();
#endif
	return m;
}
...
#ifdef APICALLBACKDEBUG
	zen_log(ULOG_DEBUG, "module", "API_CALLBACK_DEBUG", NULL, "APICallbackFind()");
	print_apicallbacks();
#endif
...
#ifdef APICALLBACKDEBUG
	zen_log(ULOG_DEBUG, "module", "API_CALLBACK_DEBUG", NULL, "unload_all_unused_apicallbacks() BEFORE");
	print_apicallbacks();
#endif
...
#ifdef APICALLBACKDEBUG
	zen_log(ULOG_DEBUG, "module", "API_CALLBACK_DEBUG", NULL, "unload_all_unused_apicallbacks() AFTER");
	print_apicallbacks();
#endif
}
