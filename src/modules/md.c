 ...
 * (C) Copyright 2014-.. Bram Matthys and The ZenIRCd Team
 *
 ...
 * Module API documentation (if writing an ZenIRCd module):
 ...
 * This is supported since ZenIRCd 6.1.1. No effort is made to
...
CMD_FUNC(cmd_md)
{
	...
	} else if (!strcmp(type, "membership"))
	{
		Client *target;
		Channel *channel;
		Membership *m;
