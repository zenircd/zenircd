...
void mm_usage(void)
{
	fprintf(stderr, "Use any of the following actions:\n"
	                ...
	                "zenircd module install name-of-module   Install the specified module\n"
	                "zenircd module uninstall name-of-module Uninstall the specified module\n"
	                "zenircd module upgrade name-of-module   Upgrade the specified module (if needed)\n"
