/* ZenIRCd configuration preprocessor
...
void init_config_defines(void)
{
	...
	add_nvplist(&config_defines, 0, "ZENIRCD_VERSION", VERSIONONLY);
	add_nvplist(&config_defines, 0, "ZENIRCD_VERSION_GENERATION", PATCH1);
	add_nvplist(&config_defines, 0, "ZENIRCD_VERSION_MAJOR", PATCH2);
	add_nvplist(&config_defines, 0, "ZENIRCD_VERSION_MINOR", PATCH3);
	add_nvplist(&config_defines, 0, "ZENIRCD_VERSION_SUFFIX", PATCH4);
#ifdef GEOIP_ENGINE
