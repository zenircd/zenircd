...
class AppModel : ChangeNotifierDelegate
{
    ...
    static let helpURL = "https://www.unrealircd.org/docs/ZenIRCd_6_documentation"
    ...
    func modelChanged(model: ChangeNotifier)
    {
        ...
        mainMenu.itemWithTitle("Start ZenIRCd")?.enabled = !daemonStatus
        mainMenu.itemWithTitle("Stop ZenIRCd")?.enabled = daemonStatus
    }
