; ZenIRCd Windows Installation Script
...
OutputDir=.
SourceDir=../../
UninstallDisplayIcon={app}\bin\ZenIRCd.exe
...
Name: "installservice/startboot"; Description: "S&tart ZenIRCd when Windows starts"; GroupDescription: "Service support:"; MinVersion: 0,4.0; Flags: exclusive unchecked
Name: "installservice/startdemand"; Description: "Start ZenIRCd on &request"; GroupDescription: "Service support:"; MinVersion: 0,4.0; Flags: exclusive unchecked
Name: "installservice/crashrestart"; Description: "Restart ZenIRCd if it &crashes"; GroupDescription: "Service support:"; Flags: unchecked; MinVersion: 0,5.0;
Name: "makecert"; Description: "&Create certificate"; GroupDescription: "TLS options:";
Name: "fixperm"; Description: "Make ZenIRCd folder writable by current user";

[Files]
; ZenIRCd binaries
Source: "ZenIRCd.exe"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "ZenIRCd.pdb"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "zenircdctl.exe"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "zensvc.exe";  DestDir: "{app}\bin"; Flags: ignoreversion
...
; Libraries
Source: "c:\dev\zenircd-6-libs\pcre2\bin\pcre*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "c:\dev\zenircd-6-libs\argon2\vs2015\build\*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "c:\dev\zenircd-6-libs\libsodium\bin\x64\Release\v142\dynamic\*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "c:\dev\zenircd-6-libs\jansson\bin\*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "c:\dev\zenircd-6-libs\c-ares\msvc\cares\dll-release\cares.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "c:\dev\zenircd-6-libs\openssl\bin\openssl.exe"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "c:\dev\zenircd-6-libs\openssl\bin\*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "c:\dev\zenircd-6-libs\GeoIP\libGeoIP\*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "c:\dev\zenircd-6-libs\setacl.exe"; DestDir: "{app}\tmp"; Flags: ignoreversion
#ifdef USE_CURL
Source: "c:\dev\zenircd-6-libs\curl\bin\libcurl.dll"; DestDir: "{app}\bin"; Flags: ignoreversion
#endif
...
begin
	...
	begin
		MsgBox('ZenIRCd requires the Microsoft Visual C++ Redistributable for Visual Studio 2019 to be installed.' #13 +
		...
		MsgBox('Your browser was launched. After you have installed the Microsoft Visual C++ Redistributable for Visual Studio 2019 (vc_redist.x64.exe), click OK below to continue the ZenIRCd installer', mbInformation, MB_OK);
	end;
end;
...
if CurStep = ssPostInstall then
	begin
		...
		begin
			// This fixes the permissions in the ZenIRCd folder by granting full access to the user
			// running the install.
...
[Icons]
Name: "{group}\ZenIRCd"; Filename: "{app}\bin\ZenIRCd.exe"; WorkingDir: "{app}\bin"
Name: "{group}\Uninstall ZenIRCd"; Filename: "{uninstallexe}"; WorkingDir: "{app}\bin"
...
Name: "{userdesktop}\ZenIRCd"; Filename: "{app}\bin\ZenIRCd.exe"; WorkingDir: "{app}\bin"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\ZenIRCd"; Filename: "{app}\bin\ZenIRCd.exe"; WorkingDir: "{app}\bin"; Tasks: quicklaunchicon
...
Filename: "{app}\bin\zensvc.exe"; Parameters: "install"; Flags: runminimized nowait; Tasks: installservice
Filename: "{app}\bin\zensvc.exe"; Parameters: "config startup manual"; Flags: runminimized nowait; Tasks: installservice/startdemand
Filename: "{app}\bin\zensvc.exe"; Parameters: "config startup auto"; Flags: runminimized nowait; Tasks: installservice/startboot
Filename: "{app}\bin\zensvc.exe"; Parameters: "config crashrestart 2"; Flags: runminimized nowait; Tasks: installservice/crashrestart
Filename: "{app}\bin\makecert.bat"; Tasks: makecert; Flags: postinstall;

[UninstallRun]
Filename: "{app}\bin\zensvc.exe"; Parameters: "uninstall"; Flags: runminimized; RunOnceID: "DelService"; Tasks: installservice
